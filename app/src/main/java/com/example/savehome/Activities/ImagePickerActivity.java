...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(Context context, PickerOptionListener listener) {
        ...
        // add a list
        String[] User = {context.getString(R.string.lbl_take_camera_picture), context.getString(R.string.lbl_choose_from_gallery)};
        builder.setItems(User, (dialog, which) -> {
            switch (which) {
                case 0:
    ...
    private void cropImage(Uri sourceUri) {
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.facebook));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.facebook));
        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.facebook));
